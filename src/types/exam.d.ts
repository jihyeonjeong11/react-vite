...
/** 서브 시험 단계 1: 추가 및 수정 */
// https://www.notion.so/SIMPREC-b5a8874803ae4190a37431ddb8910281?p=c2a2a5d41deb4e19a08fc45d3c8a74af&pm=s
...
/** 서브 시험 단계 2: 그룹별 시나리오 */
// https://www.notion.so/SIMPREC-b5a8874803ae4190a37431ddb8910281?p=b451f89608c64a15a697a6b7dd12012e&pm=s

export type ExamClassGroupProps = {
    exam_class_group_row_cd: string;
    room_cd: string;
    scenario_cd: string;
}
...
/** 서브 시험 단계 3: 대기학생 추가 */
// https://www.notion.so/SIMPREC-b5a8874803ae4190a37431ddb8910281?p=b3c89f639dce4808bf57e51029aa583d&pm=s
